...
final studentCoursesProvider = FutureProvider.autoDispose<List<CourseDto>>((ref) async {
...
final courseModulesProvider = FutureProvider.family.autoDispose<List<ModuleDto>, String>((ref, courseId) async {
  final repo = ref.watch(learningRepositoryProvider);
